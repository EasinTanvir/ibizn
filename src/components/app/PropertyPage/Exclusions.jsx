...
function Exclusions() {
  return (
    <>
      <div className="  customContainer gap-5 py-5 flex flex-col items-start justify-around md:flex-row md:gap-5  md:flex md:items-center md:justify-center md:py-20 md:bg-white px-4 lg:px-0">
        <div className="md:w-1/2 md:h-full flex flex-col items-start">
          ...
          <p className="md:text-3xl md:font-light text-secondary md:text-[16px]">
